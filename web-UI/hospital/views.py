...
#for showing signup/login button for admin(by abhishek)
...
#for showing signup/login button for doctor(by abhishek)
...
#for showing signup/login button for patient(by abhishek)
...
#-----------for checking user is doctor , patient or admin(by abhishek)
def is_admin(user):
