...
EMAIL_USE_TLS = True
EMAIL_PORT = 587
EMAIL_HOST_USER = '18xxx@nith.ac.in' # this email will be used to send emails
...
EMAIL_RECEIVING_USER = ['18xxx@nith.ac.in'] # email on which you will receive messages sent from website
